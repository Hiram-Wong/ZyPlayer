...
function B(e) {
  ...
  for (; null !== (t = P.exec(e)); ) {
    ...
    void 0 !== a
      ...
      : ((n += `${e.substring(r, i)}&#x${w(e, i).toString(16)};`), (r = P.lastIndex += Number(55296 == (64512 & s))));
  }
  return n + e.substr(r);
}
function F(e, t) {
  ...
  switch (e.type) {
    ...
    case u:
      return (function (e, t) {
        ...
        const i = (function (e, t) {
          ...
          return Object.keys(e)
            .map((n) => {
              ...
              return (
                'foreign' === t.xmlMode && (n = null !== (s = Y.get(n)) && void 0 !== s ? s : n),
        ...
        i && (r += ` ${i}`);
        0 === e.children.length && (t.xmlMode ? !1 !== t.selfClosingTags : t.selfClosingTags && j.has(e.name))
          ? (t.xmlMode || (r += ' '), (r += '/>'))
          : ((r += '>'),
      ...
      return t
        ? 'feed' === t.name
          ...
          : (function (e) {
              var t, n;
              const r =
                  null !== (n = null === (t = Ae('channel', e.children)) || void 0 === t ? void 0 : t.children) &&
                  void 0 !== n
                    ? n
                    : [],
                i = {
...
((He.prototype.evaluate = function (e, t, n, r) {
  ...
  (He.prototype._trace = function (e, t, n, r, i, s, a, o) {
    ...
    if (('string' != typeof l || o) && t && we.call(t, l)) p(this._trace(h, t[l], Be(n, l), t, l, s, a));
      ...
      if ('^' === l) return ((this._hasParentSelector = !0), { path: n.slice(0, -1), expr: h, isParentSelector: !0 });
      if ('~' === l)
        return (
...
function St(e, t, n, r) {
  ...
  if (
    ((s = e._events)
      ? (s.newListener && (e.emit('newListener', t, n.listener ? n.listener : n), (s = e._events)), (a = s[t]))
  ...
  (Tt.prototype.removeAllListeners = function (e) {
    ...
    if (!n.removeListener)
      return (
        0 === arguments.length
          ? ((this._events = new mt()), (this._eventsCount = 0))
          : n[e] && (0 == --this._eventsCount ? (this._events = new mt()) : delete n[e]),
        this
      );
      ...
      (t.nextToken = function () {
        ...
        if (this.in_code) {
          ...
          if (-1 !== '()[]{}%*-+~/#,:|.<>=!'.indexOf(r)) {
            ...
            switch (
              (-1 !== je.indexOf(c, l) &&
                (this.forward(),
                (r = l),
                -1 !== je.indexOf(c, l + this.current()) && ((r = l + this.current()), this.forward())),
              r)
            ) {
              case '(':
                o = 'left-paren';
          ...
          if ((e = this._extractUntil(' \n\t\r ()[]{}%*-+~/#,:|.<>=!')).match(/^[-+]?[0-9]+$/))
            return '.' === this.current()
              ? (this.forward(), Kt('float', e + '.' + this._extract('0123456789'), t, n))
              : Kt('int', e, t, n);
    ...
    return (
      ...
      (i.parseCall = function () {
        ...
        var i = new hr.Symbol(e.lineno, e.colno, 'caller'),
          ...
          a = n.args.children;
        return (
          a[a.length - 1] instanceof hr.KeywordArgs || a.push(new hr.KeywordArgs()),
      ...
      (i.parseFrom = function () {
        ...
        for (var n, r = new hr.NodeList(); ; ) {
          ...
          if (
            ('_' === s.value.charAt(0) &&
              this.fail('parseFrom: names starting with an underscore cannot be imported', s.lineno, s.colno),
            this.skipSymbol('as'))
          ) {
        ...
        return (
          this.skipValue(Vt.TOKEN_OPERATOR, '=')
            ...
            : this.skip(Vt.TOKEN_BLOCK_END)
              ? ((n.body = new hr.Capture(e.lineno, e.colno, this.parseUntilBlocks('endset'))),
                (n.value = null),
                this.advanceAfterBlockEnd())
      ...
      (i.parseStatement = function () {
        var e = this.peekToken();
        if (
          (e.type !== Vt.TOKEN_SYMBOL && this.fail('tag name expected', e.lineno, e.colno),
                ...
                : n.type === Vt.TOKEN_FLOAT
                  ...
                  : n.type === Vt.TOKEN_BOOLEAN
                    ...
                    : n.type === Vt.TOKEN_NONE
                      ? (t = null)
                      : n.type === Vt.TOKEN_REGEX && (t = new RegExp(n.value.body, n.value.flags))
      ...
      (i.parseFilter = function (e) {
        for (; this.skip(Vt.TOKEN_PIPE); ) {
          ...
          e = new hr.Filter(
            ...
            t.colno,
            t,
            new hr.NodeList(t.lineno, t.colno, [e].concat(this.parseFilterArgs(e))),
          );
        }
        return e;
      }),
      ...
      (i.parseSignature = function (e, t) {
        ...
        for (var r = new hr.NodeList(n.lineno, n.colno), i = new hr.KeywordArgs(n.lineno, n.colno), s = !1; ; ) {
          ...
          if (s && !this.skip(Vt.TOKEN_COMMA))
            ...
            this.skipValue(Vt.TOKEN_OPERATOR, '=')
              ? i.addChild(new hr.Pair(a.lineno, a.colno, a, this.parseExpression()))
              : r.addChild(a);
          }
          s = !0;
        }
        ...
        for (var e, t = []; (e = this.nextToken()); )
          if (e.type === Vt.TOKEN_DATA) {
            ...
            (this.dropLeadingWhitespace && ((n = n.replace(/^\s*/, '')), (this.dropLeadingWhitespace = !1)),
              r &&
                ((r.type === Vt.TOKEN_BLOCK_START && '-' === i.charAt(i.length - 1)) ||
                  (r.type === Vt.TOKEN_VARIABLE_START && '-' === i.charAt(this.tokens.tags.VARIABLE_START.length)) ||
                  (r.type === Vt.TOKEN_COMMENT && '-' === i.charAt(this.tokens.tags.COMMENT_START.length))) &&
                (n = n.replace(/\s*$/, '')),
  ...
  var r = [],
    i = _r(n ? e[n] : e, function (e) {
      ...
      return e instanceof hr.Block
        ? e
        : (((e instanceof hr.Filter && -1 !== je.indexOf(t, e.name.value)) || e instanceof hr.CallExtensionAsync) &&
...
function Lr(e) {
  ...
  ((this.val = e), Object.defineProperty(this, 'length', { writable: !0, configurable: !0, value: e.length }));
}
((Lr.prototype = Object.create(String.prototype, { length: { writable: !0, configurable: !0, value: 0 } })),
    ...
    return (
      ...
      (i.compileSet = function (e, t) {
        ...
        (e.targets.forEach(function (e) {
          ...
          e.value
            ? (this._emit(r.join(' = ') + ' = '), this._compileExpression(e.value, t), this._emitLine(';'))
            : (this._emit(r.join(' = ') + ' = '), this.compile(e.body, t), this._emitLine(';')),
        ...
        (this._addScopeLevel(),
          ...
          e.names.children.forEach(function (e) {
            var i,
              s,
              a = n._tmpid();
            (e instanceof hr.Pair ? ((i = e.key.value), (s = e.value.value)) : (s = i = e.value),
      ...
      (t.sort = kr.makeMacro(['value', 'reverse', 'case_sensitive', 'attribute'], [], function (e, t, n, r) {
        ...
        return (
          s.sort(function (e, s) {
            ...
            return (
              !n && je.isString(o) && je.isString(c) && ((o = o.toLowerCase()), (c = c.toLowerCase())),
  ...
  ei = (function (e) {
    function t(t, n) {
      ...
      return (
        ...
        (r.noCache = !!n.noCache),
        t ? ((t = Array.isArray(t) ? t : [t]), (r.searchPaths = t.map(Kr.normalize))) : (r.searchPaths = ['.']),
        r
      );
    }
    return (
      ...
      (t.prototype.getSource = function (e) {
        ...
        var a = { src: Br.readFileSync(t, 'utf-8'), path: t, noCache: this.noCache };
    ...
    NodeResolveLoader: (function (e) {
      ...
      return (
        ...
        (t.prototype.getSource = function (e) {
          ...
          this.pathsToNames[t] = e;
          var n = { src: Br.readFileSync(t, 'utf-8'), path: t, noCache: this.noCache };
        ...
        return (
          je.asyncIter(
            ...
            function (n, o) {
              ...
              var c;
              (o
                ? ((c = new _i(o.src, a, o.path, t)), o.noCache || (o.loader.cache[e] = c))
                : (c = new _i(Ei, a, '', t)),
                i ? i(null, c) : (s = c));
            },
          ),
...
function Ci(e, t) {
  ...
  return (
    ...
    ti.FileSystemLoader
      ...
      : ti.WebLoader && (n = new ti.WebLoader(e, { useCache: t.web && t.web.useCache, async: t.web && t.web.async })),
    (gi = new Ni(n, t)),
...
function Oi(e, t) {
  return bi(
    ...
    (function (e, t) {
      ...
      ? void (t = e)
      : e,
    Si(Si(Si({}, n), null == this ? void 0 : this._options), i(null != t ? t : {})),
  );
}
function yi(e) {
...
function Ui(e) {
  ...
  return (
    ((n >= Pi.LowerA && n <= Pi.LowerZ) || (n >= Pi.UpperA && n <= Pi.UpperZ) || n === Pi.Exclamation) &&
    e.includes('>', t + 2)
  );
}
!(function (e) {
...
var Zi,
  ...
  ts = Object.freeze({
    ...
    toggleClass: function e(t, n) {
      ...
      if (!t || 'string' != typeof t) return this;
      for (
        var r = t.split(Gi), i = r.length, s = 'boolean' == typeof n ? (n ? 1 : -1) : 0, a = this.length, o = 0;
        o < a;
        o++
      ) {
        var c = this[o];
...
function fs(e, t, n) {
  ...
  function l(e) {
    r.length > 0 && r[r.length - 1].type === Zi.Descendant ? (r[r.length - 1].type = e) : (c(), r.push({ type: e }));
  }
  function h(e, t) {
    r.push({ type: Zi.Attribute, name: e, action: t, value: i(1), namespace: null, ignoreCase: 'quirks' });
  }
  function u() {
    if ((r.length && r[r.length - 1].type === Zi.Descendant && r.pop(), 0 === r.length))
  ...
  e: for (; n < t.length; ) {
    ...
    switch (e) {
      ...
      case 12:
      case 13:
        ((0 !== r.length && r[0].type === Zi.Descendant) || (c(), r.push({ type: Zi.Descendant })), s(1));
        break;
      case 62:
        (l(Zi.Child), s(1));
        break;
      ...
      case 91: {
        ...
        n += 1;
        const p = { type: Zi.Attribute, name: e, action: c, value: h, namespace: a, ignoreCase: u };
        r.push(p);
        break;
      }
      case 58: {
        if (58 === t.charCodeAt(n + 1)) {
          r.push({ type: Zi.PseudoElement, name: i(2).toLowerCase(), data: 40 === t.charCodeAt(n) ? a() : null });
          continue;
        }
      ...
      default: {
        ...
        (124 === t.charCodeAt(n) &&
          ...
          r.push('*' === a ? { type: Zi.Universal, namespace: o } : { type: Zi.Tag, name: a, namespace: o }));
      }
    }
  }
  return (u(), n);
        ...
        (e.data
          ? 'has' === e.name || 'contains' === e.name
            ...
            : Array.isArray(e.data)
              ? ((r = Math.min(...e.data.map((e) => Math.min(...e.map(gs))))), r < 0 && (r = 0))
              : (r = 2)
          : (r = 3)),
    r
  );
      ...
      : Ss(t, n)
        ? ((s = s.toLowerCase()),
          (t) => {
            var n;
            return (
              (null === (n = r.getAttributeValue(t, i)) || void 0 === n ? void 0 : n.substr(a).toLowerCase()) === s &&
              e(t)
            );
          })
        : (t) => {
...
var Os = Ke(function (e, t) {
  ...
  t.parse = function (e) {
    ...
    if (
      (t < e.length &&
        'n' === e.charAt(t) &&
        (t++, (s = a * (null != o ? o : 1)), h(), t < e.length ? ((a = c()), h(), (o = l())) : (a = o = 0)),
      null === o || t < e.length)
    )
  ...
  const o = e
    .map((e) => {
      if (e.length >= 2) {
        ...
        t.type !== Zi.Pseudo ||
          'scope' !== t.name ||
          (i && n.type === Zi.Descendant ? (e[1] = Ws) : (n.type !== Zi.Adjacent && n.type !== Zi.Sibling) || (a = !0));
      }
      return (function (e, t, n) {
        var r;
        return e.reduce(
    ...
    const r = (function (e) {
      ...
      return (
        ...
        (null !== (n = s.equals) && void 0 !== n) ||
          (s.equals =
            null !== (i = null === (r = s.adapter) || void 0 === r ? void 0 : r.equals) && void 0 !== i ? i : zs),
        s
      );
    })(t);
    return ea(e, r, n);
...
function ra(e) {
  return (
    'pseudo' === e.type &&
    (!!na.has(e.name) || (!('not' !== e.name || !Array.isArray(e.data)) && e.data.some((e) => e.some(ra))))
  );
}
function ia(e) {
  const t = [],
  ...
  return function (t) {
    ...
    return function (r) {
      var i,
        s = e(t, this);
      return (
        r && (s = xa(s, r, this.options.xmlMode, null === (i = this._root) || void 0 === i ? void 0 : i[0])),
        this._make(
...
function Na(e) {
  ...
  var r = null,
    i = _a(function (e, t) {
      ...
      return (
        Bi(t, function (t) {
          for (var i; (i = e(t)) && !(null == r ? void 0 : r(i, n.length)); t = i) n.push(i);
        }),
        n
      );
...
function xa(e, t, n, r) {
  return 'string' == typeof t ? la(t, e, { xmlMode: n, root: r }) : e.filter(Pa(t));
}
var wa = Object.freeze({
  ...
  closest: function (e) {
    ...
    var r = { xmlMode: this.options.xmlMode, root: null === (t = this._root) || void 0 === t ? void 0 : t[0] },
      i =
        'string' == typeof e
          ? function (t) {
              return oa(t, e, r);
  ...
  filter: function (e) {
    var t;
    return this._make(
      xa(this.toArray(), e, this.options.xmlMode, null === (t = this._root) || void 0 === t ? void 0 : t[0]),
    );
  },
  filterArray: xa,
  is: function (e) {
  ...
  eq: function (e) {
    ...
    return 0 === (e = +e) && this.length <= 1
      ? this
      : (e < 0 && (e = this.length + e), this._make(null !== (t = this[e]) && void 0 !== t ? t : []));
  },
  get: function (e) {
...
function Ha(e, t, n, r, i) {
  for (
    var s, a, o = Fa([t, n], r, !0), c = 0 === t ? null : e[t - 1], l = t + n >= e.length ? null : e[t + n], h = 0;
    h < r.length;
    ++h
  ) {
    var u = r[h],
        ...
        for (var r = '', i = 0, c = 0; (c = t.indexOf('&', c)) >= 0; )
          if (((r += t.slice(i, c)), (i = c), (c += 1), t.charCodeAt(c) !== a.NUM)) {
            ...
            do {
              ...
              (_ >= a.ZERO && _ <= a.NINE) ||
              (16 === T && (_ | a.To_LOWER_BIT) >= a.LOWER_A && (_ | a.To_LOWER_BIT) <= a.LOWER_F)
            );
            if (m !== c) {
...
class tc {
  ...
  _createCommentToken(e) {
    this.currentToken = { type: To.COMMENT, data: '', location: this.getCurrentLocation(e) };
  }
      ...
      if (o) {
        ...
        if (
          ...
          ((i = this.preprocessor.peek(1)) === io.EQUALS_SIGN || Xo(i))
            ? ((t = [io.AMPERSAND]), (s += a))
            : ((t = 0 === a ? [wo[s] & ~yo.VALUE_LENGTH] : 1 === a ? [wo[++s]] : [wo[++s], wo[++s]]),
              (n = 0),
              (r = e !== io.SEMICOLON)),
          0 === a)
        ) {
  ...
  _stateRawtextEndTagOpen(e) {
    Qo(e)
      ? ((this.state = Ko.RAWTEXT_END_TAG_NAME), this._stateRawtextEndTagName(e))
      : (this._emitChars('</'), (this.state = Ko.RAWTEXT), this._stateRawtext(e));
  }
  ...
  _stateScriptDataEndTagOpen(e) {
    Qo(e)
      ? ((this.state = Ko.SCRIPT_DATA_END_TAG_NAME), this._stateScriptDataEndTagName(e))
      : (this._emitChars('</'), (this.state = Ko.SCRIPT_DATA), this._stateScriptData(e));
  }
    ...
    e === io.SOLIDUS
      ...
      : Qo(e)
        ? (this._emitChars('<'),
          ...
          this._stateScriptDataDoubleEscapeStart(e))
        : (this._emitChars('<'), (this.state = Ko.SCRIPT_DATA_ESCAPED), this._stateScriptDataEscaped(e));
  }
  _stateScriptDataEscapedEndTagOpen(e) {
    Qo(e)
      ? ((this.state = Ko.SCRIPT_DATA_ESCAPED_END_TAG_NAME), this._stateScriptDataEscapedEndTagName(e))
      : (this._emitChars('</'), (this.state = Ko.SCRIPT_DATA_ESCAPED), this._stateScriptDataEscaped(e));
  }
  ...
  _stateScriptDataDoubleEscapedLessThanSign(e) {
    e === io.SOLIDUS
      ...
      : ((this.state = Ko.SCRIPT_DATA_DOUBLE_ESCAPED), this._stateScriptDataDoubleEscaped(e));
  }
  ...
  _stateMarkupDeclarationOpen(e) {
    this._consumeSequenceIfMatch(so, !0)
      ? (this._createCommentToken(so.length + 1), (this.state = Ko.COMMENT_START))
      : this._consumeSequenceIfMatch(oo, !1)
        ? ((this.currentLocation = this.getCurrentLocation(oo.length + 1)), (this.state = Ko.DOCTYPE))
  ...
  _stateCharacterReference(e) {
    e === io.NUMBER_SIGN
      ...
      : Xo(e)
        ? ((this.state = Ko.NAMED_CHARACTER_REFERENCE), this._stateNamedCharacterReference(e))
        : (this._flushCodePointConsumedAsCharacterReference(io.AMPERSAND), this._reconsumeInState(this.returnState, e));
  }
  ...
  _stateNumericCharacterReference(e) {
    ((this.charRefCode = 0),
      e === io.LATIN_SMALL_X || e === io.LATIN_CAPITAL_X
        ...
        : Vo(e)
          ? ((this.state = Ko.DECIMAL_CHARACTER_REFERENCE), this._stateDecimalCharacterReference(e))
  ...
  _stateHexademicalCharacterReferenceStart(e) {
    !(function (e) {
      ...
      ? (this._err(Eo.absenceOfDigitsInNumericCharacterReference),
        ...
        this._unconsume(2),
        (this.state = this.returnState))
      : ((this.state = Ko.HEXADEMICAL_CHARACTER_REFERENCE), this._stateHexademicalCharacterReference(e));
  }
  ...
  _stateNumericCharacterReferenceEnd(e) {
    if (this.charRefCode === io.NULL)
      (this._err(Eo.nullCharacterReference), (this.charRefCode = io.REPLACEMENT_CHARACTER));
    else if (this.charRefCode > 1114111)
      (this._err(Eo.characterReferenceOutsideUnicodeRange), (this.charRefCode = io.REPLACEMENT_CHARACTER));
    else if (uo(this.charRefCode))
      (this._err(Eo.surrogateCharacterReference), (this.charRefCode = io.REPLACEMENT_CHARACTER));
...
class fc {
  ...
  pushElement(e, t) {
    (this._ensureNoahArkCondition(e), this.entries.unshift({ type: uc.Element, element: e, token: t }));
  }
...
const Ec = {
    createDocument: () => ({ nodeName: '#document', mode: Ro.NO_QUIRKS, childNodes: [] }),
...
const Cc = 'text/html',
  ...
  bc = new Map([
    ['xlink:actuate', { prefix: 'xlink', name: 'actuate', namespace: vo.XLINK }],
    ['xlink:arcrole', { prefix: 'xlink', name: 'arcrole', namespace: vo.XLINK }],
...
const Mc = { startLine: -1, startCol: -1, startOffset: -1, endLine: -1, endCol: -1, endOffset: -1 },
  Pc = new Set([Po.TABLE, Po.TBODY, Po.TFOOT, Po.THEAD, Po.TR]),
  xc = { scriptingEnabled: !0, sourceCodeLocationInfo: !1, treeAdapter: Ec, onParseError: null };
class wc {
  ...
  static getFragmentParser(e, t) {
    ...
    const r = n.treeAdapter.createElement('documentmock', vo.HTML, []),
      i = new this(n, r, e);
    return (
      i.fragmentContextID === Po.TEMPLATE && i.tmplInsertionModeStack.unshift(Rc.IN_TEMPLATE),
  ...
  _insertCharacters(e) {
    ...
    if (this.treeAdapter.getNodeSourceCodeLocation(s)) {
      ...
      this.treeAdapter.updateNodeSourceCodeLocation(s, { endLine: t, endCol: n, endOffset: r });
    ...
    return (
      ...
      (e.tagID !== Po.SVG ||
        ...
        (this.tokenizer.inForeignNode ||
          ((e.tagID === Po.MGLYPH || e.tagID === Po.MALIGNMARK) && !this._isIntegrationPoint(n, t, vo.HTML)))
    );
  }
  _processToken(e) {
    switch (e.type) {
    ...
    switch (((this.skipNextNewLine = !1), this.insertionMode)) {
      case Rc.INITIAL:
        !(function (e, t) {
          ...
          (function (e) {
            return (
              'html' === e.name && null === e.publicId && (null === e.systemId || 'about:legacy-compat' === e.systemId)
            );
      ...
      ? (function (e, t) {
          if (
            (function (e) {
              const t = e.tagID;
              return (
                (t === Po.FONT && e.attrs.some(({ name: e }) => e === Do.COLOR || e === Do.SIZE || e === Do.FACE)) ||
                yc.has(t)
              );
            })(t)
          )
    ...
    switch (this.insertionMode) {
      ...
      case Rc.IN_CELL:
        !(function (e, t) {
          const n = t.tagID;
          _l.has(n)
            ? (e.openElements.hasInTableScope(Po.TD) || e.openElements.hasInTableScope(Po.TH)) &&
      ...
      case Rc.IN_SELECT_IN_TABLE:
        !(function (e, t) {
          ...
          n === Po.TD ||
          n === Po.TH
            ? (e.openElements.popUntilTagNamePopped(Po.SELECT), e._resetInsertionMode(), e._processStartTag(t))
            : bl(e, t);
        })(this, e);
        break;
      case Rc.IN_TEMPLATE:
    ...
    switch (this.insertionMode) {
      ...
      case Rc.IN_SELECT_IN_TABLE:
        !(function (e, t) {
          ...
          n === Po.TH
            ? e.openElements.hasInTableScope(n) &&
              (e.openElements.popUntilTagNamePopped(Po.SELECT), e._resetInsertionMode(), e.onEndTag(t))
            : Ol(e, t);
        })(this, e);
        break;
      case Rc.IN_TEMPLATE:
  ...
  switch (t.tagID) {
    ...
    case Po.NOSCRIPT:
      e.options.scriptingEnabled
        ...
        : (e._insertElement(t, vo.HTML), (e.insertionMode = Rc.IN_HEAD_NO_SCRIPT));
      break;
    case Po.NOFRAMES:
    case Po.STYLE:
      e._switchToTextParsing(t, jo.RAWTEXT);
  ...
  switch (t.tagID) {
    ...
    case Po.A:
      !(function (e, t) {
        ...
        (n && (qc(e, t), e.openElements.remove(n.element), e.activeFormattingElements.removeEntry(n)),
          e._reconstructActiveFormattingElements(),
          e._insertElement(t, vo.HTML),
          e.activeFormattingElements.pushElement(e.openElements.current, t));
      })(e, t);
    ...
    case Po.NOBR:
      !(function (e, t) {
        (e._reconstructActiveFormattingElements(),
          e.openElements.hasInScope(Po.NOBR) && (qc(e, t), e._reconstructActiveFormattingElements()),
          e._insertElement(t, vo.HTML),
          e.activeFormattingElements.pushElement(e.openElements.current, t));
      })(e, t);
      break;
    ...
    case Po.BUTTON:
      !(function (e, t) {
        (e.openElements.hasInScope(Po.BUTTON) &&
          (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(Po.BUTTON)),
          e._reconstructActiveFormattingElements(),
          e._insertElement(t, vo.HTML),
          (e.framesetOk = !1));
      })(e, t);
    ...
    case Po.LI:
      !(function (e) {
        e.openElements.hasInListItemScope(Po.LI) &&
          (e.openElements.generateImpliedEndTagsWithExclusion(Po.LI), e.openElements.popUntilTagNamePopped(Po.LI));
      })(e);
      break;
    case Po.DD:
    case Po.DT:
    ...
    case Po.FORM:
      !(function (e, t) {
        e.formElement ||
          ...
          (e._insertElement(t, vo.HTML), (e.formElement = e.openElements.current), e.openElements.pop());
      })(e, t);
      break;
    case Po.TABLE:
      !(function (e, t) {
        e.openElements.hasInTableScope(Po.TABLE) &&
          (e.openElements.popUntilTagNamePopped(Po.TABLE), e._resetInsertionMode(), e._processStartTag(t));
      })(e, t);
      break;
    case Po.TBODY:
    case Po.TFOOT:
...
function fl(e, t) {
  switch (t.tagID) {
    case Po.TABLE:
      e.openElements.hasInTableScope(Po.TABLE) &&
        (e.openElements.popUntilTagNamePopped(Po.TABLE), e._resetInsertionMode());
      break;
    case Po.TEMPLATE:
      $c(e, t);
      break;
  ...
  switch (t.tagID) {
    ...
    case Po.THEAD:
      e.openElements.hasTableBodyContextInTableScope() &&
        (e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), (e.insertionMode = Rc.IN_TABLE), pl(e, t));
      break;
    default:
      pl(e, t);
  }
...
function Cl(e, t) {
  ...
  switch (t.tagID) {
    ...
    case Po.THEAD:
      e.openElements.hasInTableScope(n) &&
        (e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), (e.insertionMode = Rc.IN_TABLE));
      break;
    case Po.TABLE:
      e.openElements.hasTableBodyContextInTableScope() &&
        (e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), (e.insertionMode = Rc.IN_TABLE), fl(e, t));
      break;
    case Po.BODY:
    case Po.CAPTION:
    case Po.COL:
...
function Sl(e, t) {
  switch (t.tagID) {
    case Po.TR:
      e.openElements.hasInTableScope(Po.TR) &&
        (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), (e.insertionMode = Rc.IN_TABLE_BODY));
      break;
    case Po.TABLE:
      e.openElements.hasInTableScope(Po.TR) &&
        (e.openElements.clearBackToTableRowContext(),
    ...
    case Po.TFOOT:
    case Po.THEAD:
      (e.openElements.hasInTableScope(t.tagID) || e.openElements.hasInTableScope(Po.TR)) &&
        (e.openElements.clearBackToTableRowContext(),
        e.openElements.pop(),
        (e.insertionMode = Rc.IN_TABLE_BODY),
        Cl(e, t));
...
function Ol(e, t) {
  switch (t.tagID) {
    ...
    case Po.SELECT:
      e.openElements.hasInSelectScope(Po.SELECT) &&
        (e.openElements.popUntilTagNamePopped(Po.SELECT), e._resetInsertionMode());
      break;
    case Po.TEMPLATE:
      $c(e, t);
  }
  ...
  function r(e) {
    for (var r, i = '', s = 0; null !== (r = t.xmlReplacer.exec(e)); ) {
      ...
      void 0 !== c
        ...
        : ((i += ''.concat(e.substring(s, a), '&#x').concat((0, t.getCodePoint)(e, a).toString(16), ';')),
    ...
    : t.treeAdapter.isTextNode(e)
      ? (function (e, t) {
          ...
          return s &&
            ...
            ((a = s), (o = t.scriptingEnabled), Yo.has(a) || (o && a === Mo.NOSCRIPT))
            ? r
            : Ml(r);
          var a, o;
        })(e, t)
...
const Gl = {
  ...
  createElement(e, t, n) {
    ...
    const a = new C(e, r, []);
    return ((a.namespace = t), (a['x-attribsNamespace'] = i), (a['x-attribsPrefix'] = s), a);
  },
  ...
  setDocumentType(e, t, n, r) {
    const i = (function (e, t, n) {
      let r = '!DOCTYPE ';
      return (e && (r += e), t ? (r += ` PUBLIC ${Hl(t)}`) : n && (r += ' SYSTEM'), n && (r += ` ${Hl(n)}`), r);
    })(t, n, r);
    let s = e.children.find((e) => y(e) && '!doctype' === e.name);
    (s ? (s.data = null != i ? i : null) : ((s = new _('!doctype', i)), Gl.appendChild(e, s)),
...
class Jl {
  ...
  stateSpecialStartSequence(e) {
    ...
    ((this.sequenceIndex = 0), (this.state = jl.InTagName), this.stateInTagName(e));
  }
  stateInSpecialTag(e) {
  ...
  stateCDATASequence(e) {
    e === zl.Cdata[this.sequenceIndex]
      ...
      : ((this.sequenceIndex = 0), (this.state = jl.InDeclaration), this.stateInDeclaration(e));
  }
  fastForwardTo(e) {
  ...
  stateBeforeTagName(e) {
    if (e === Kl.ExclamationMark) ((this.state = jl.BeforeDeclaration), (this.sectionStart = this.index + 1));
    else if (e === Kl.Questionmark) ((this.state = jl.InProcessingInstruction), (this.sectionStart = this.index + 1));
    else if (this.isTagStartChar(e)) {
      const t = 32 | e;
      ((this.sectionStart = this.index),
        this.xmlMode || t !== zl.TitleEnd[2]
          ? (this.state = this.xmlMode || t !== zl.ScriptEnd[2] ? jl.InTagName : jl.BeforeSpecialS)
          : this.startSpecial(zl.TitleEnd, 3));
    } else e === Kl.Slash ? (this.state = jl.BeforeClosingTagName) : ((this.state = jl.Text), this.stateText(e));
  }
  stateInTagName(e) {
    Xl(e) &&
  ...
  stateBeforeClosingTagName(e) {
    Ql(e) ||
      (e === Kl.Gt
        ? (this.state = jl.Text)
        : ((this.state = this.isTagStartChar(e) ? jl.InClosingTagName : jl.InSpecialComment),
          (this.sectionStart = this.index)));
  }
  ...
  stateAfterClosingTagName(e) {
    (e === Kl.Gt || this.fastForwardTo(Kl.Gt)) && ((this.state = jl.Text), (this.sectionStart = this.index + 1));
  }
  stateBeforeAttributeName(e) {
    e === Kl.Gt
      ? (this.cbs.onopentagend(this.index),
        this.isSpecial ? ((this.state = jl.InSpecialTag), (this.sequenceIndex = 0)) : (this.state = jl.Text),
        (this.baseState = this.state),
        (this.sectionStart = this.index + 1))
      : e === Kl.Slash
        ? (this.state = jl.InSelfClosingTag)
        : Ql(e) || ((this.state = jl.InAttributeName), (this.sectionStart = this.index));
  }
  stateInSelfClosingTag(e) {
    e === Kl.Gt
      ? (this.cbs.onselfclosingtag(this.index),
        ...
        (this.sectionStart = this.index + 1),
        (this.isSpecial = !1))
      : Ql(e) || ((this.state = jl.BeforeAttributeName), this.stateBeforeAttributeName(e));
  }
  ...
  stateBeforeAttributeValue(e) {
    e === Kl.DoubleQuote
      ? ((this.state = jl.InAttributeValueDq), (this.sectionStart = this.index + 1))
      : e === Kl.SingleQuote
        ? ((this.state = jl.InAttributeValueSq), (this.sectionStart = this.index + 1))
        : Ql(e) ||
          ((this.sectionStart = this.index),
  ...
  handleInAttributeValue(e, t) {
    e === t || (!this.decodeEntities && this.fastForwardTo(t))
      ? (this.cbs.onattribdata(this.sectionStart, this.index),
        ...
        (this.state = jl.BeforeAttributeName))
      : this.decodeEntities && e === Kl.Amp && ((this.baseState = this.state), (this.state = jl.BeforeEntity));
  }
  ...
  stateInNumericEntity(e) {
    e === Kl.Semi
      ...
      : $l(e)
        ? ((this.entityResult = 10 * this.entityResult + (e - Kl.Zero)), this.entityExcess++)
  ...
  stateInHexEntity(e) {
    e === Kl.Semi
      ? this.emitNumericEntity(!0)
      : $l(e)
        ? ((this.entityResult = 16 * this.entityResult + (e - Kl.Zero)), this.entityExcess++)
        : !(function (e) {
              return (e >= Kl.UpperA && e <= Kl.UpperF) || (e >= Kl.LowerA && e <= Kl.LowerF);
            })(e)
          ? (this.allowLegacyEntity() ? this.emitNumericEntity(!1) : (this.state = this.baseState), this.index--)
          : ((this.entityResult = 16 * this.entityResult + ((32 | e) - Kl.LowerA + 10)), this.entityExcess++);
  }
  allowLegacyEntity() {
  ...
  cleanup() {
    this.running &&
      this.sectionStart !== this.index &&
      (this.state === jl.Text || (this.state === jl.InSpecialTag && 0 === this.sequenceIndex)
                                                    ...
                                                    : this.state === jl.InProcessingInstruction
                                                      ...
                                                      : this.state === jl.InNamedEntity
                                                        ...
                                                        : this.state === jl.BeforeEntity
                                                          ...
                                                          : this.state === jl.InHexEntity
                                                            ? this.stateInHexEntity(e)
                                                            : this.state === jl.InNumericEntity
...
class lh {
  ...
  emitOpenTag(e) {
    ...
    (this.isVoidElement(e) ||
      (this.stack.push(e), ah.has(e) ? this.foreignContext.push(!0) : oh.has(e) && this.foreignContext.push(!1)),
    ...
    ((this.endIndex = t),
      null === (r = (n = this.cbs).onattribute) ||
        ...
        r.call(
          ...
          this.attribname,
          this.attribvalue,
          e === Vl.Double ? '"' : e === Vl.Single ? "'" : e === Vl.NoValue ? void 0 : null,
        ),
      this.attribs &&
  ...
  oncdata(e, t, n) {
    ...
    (this.options.xmlMode || this.options.recognizeCDATA
      ...
      : (null === (h = (l = this.cbs).oncomment) || void 0 === h || h.call(l, `[CDATA[${f}]]`),
...
var hh = (function (e) {
    return function (t, n, r, i) {
      if (('undefined' != typeof Buffer && Buffer.isBuffer(t) && (t = t.toString()), 'string' == typeof t))
        return e(t, n, r, i);
      var s = t;
  ...
  uh = (function (e, t) {
    return function r(s, a, o) {
        ...
        var p,
          f =
            'string' == typeof t && Ui(t)
              ...
              : (p = t).name || 'root' === p.type || 'text' === p.type || 'comment' === p.type
                ? [t]
                : Array.isArray(t)
                  ? t
                  : void 0,
      ...
      return (Object.assign(u, xi, { load: r, _root: l, _options: c, fn: h.prototype, prototype: h.prototype }), u);
    };
  })(hh, function (e, t) {
    return t.xmlMode || t._useHtmlParser2
      ? V(e, t)

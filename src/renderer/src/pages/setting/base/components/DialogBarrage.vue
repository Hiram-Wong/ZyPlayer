<template>
  <t-dialog
    ...
    :header="$t('pages.setting.barrage.title')"
    placement="center"
    :footer="false"
  >
    <template #body>
        ...
        <t-form ref="form" :data="formData" @submit="onSubmit">
          <t-space direction="vertical">
            <t-input
              ...
              :label="$t('pages.setting.barrage.api')"
              :placeholder="$t('pages.setting.placeholder.general')"
              :style="{ width: '408px' }"
            />
            <t-input
              v-model="formData.key"
              :label="$t('pages.setting.barrage.key')"
              :placeholder="$t('pages.setting.placeholder.general')"
              :style="{ width: '408px' }"
            />
            <t-tag-input
              v-model="formData.support"
              :label="$t('pages.setting.barrage.support')"
            ...
            <t-space align="center">
              <t-input
                ...
                :label="$t('pages.setting.barrage.start')"
                :placeholder="$t('pages.setting.placeholder.general')"
                :style="{ width: '90px' }"
              />
              <t-input
                v-model="formData.color"
                :label="$t('pages.setting.barrage.color')"
                :placeholder="$t('pages.setting.placeholder.general')"
                :style="{ width: '90px' }"
              />
              <t-input
                v-model="formData.mode"
                :label="$t('pages.setting.barrage.mode')"
                :placeholder="$t('pages.setting.placeholder.general')"
                :style="{ width: '90px' }"
              />
              <t-input
                v-model="formData.content"
                :label="$t('pages.setting.barrage.content')"
                :placeholder="$t('pages.setting.placeholder.general')"
                :style="{ width: '90px' }"
              />
            </t-space>

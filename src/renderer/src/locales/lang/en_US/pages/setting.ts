export default {
  ...
  placeholder: {
    ...
    shortcutInput: 'Click this to set',
    shortcutPress: 'Press shortcut key combination',
    shortcutErrCompliance: 'Shortcut key not compliant',
    shortcutErrRegistered: 'Shortcut key conflicts',
  ...
  message: {
    reboot: 'Application will be restarted',
  ...
  update: {
    ...
    foundNewVersion: 'Discover new version',
    changelog: 'ChangeLog',
    errorlog: 'ErrorLog',

  ...
  (Fa.prototype._getPreferredOutput = function (e) {
    ...
    switch (t) {
      case 'all': {
        ...
        return (
          (e.pointer = Fa.toPointer(t)), (e.path = 'string' == typeof e.path ? e.path : Fa.toPathString(e.path)), e
        );
      }
      case 'value':
      case 'parent':
      ...
      (t.parsePostfix = function (e) {
        for (var t, n = this.peekToken(); n; ) {
          if (n.type === uc.TOKEN_LEFT_PAREN) e = new bu.FunCall(n.lineno, n.colno, e, this.parseSignature());
            ...
            r.type !== uc.TOKEN_SYMBOL && this.fail('expected name as lookup value, got ' + r.value, r.lineno, r.colno),
  ...
  Hu = (function () {
    ...
    return (
      ...
      (t.resolve = function (e, t) {
        return (
          (t = t && this.isolateWrites ? void 0 : this.parent), void 0 !== this.variables[e] ? this : t && t.resolve(e)
        );
      }),
      (t.push = function (t) {
        return new e(this, t);
...
class lh {
  ...
  startOf(e, t) {
    const n = !!uh.u(t) || t,
      r = uh.p(e),
      i = (e, t) => (
        (t = uh.w(this.$u ? Date.UTC(this.$y, t, e) : new Date(this.$y, t, e), this)), n ? t : t.endOf(Kl)
      ),
      s = (e, t) =>
        ...
        _n = (function e(t) {
          ...
          return (
            ...
            (Gn.startsWith = function (e, t, n) {
              return (
                (e = Ao(e)), (n = null == n ? 0 : cr(mo(n), 0, e.length)), (t = li(t)), e.slice(n, n + t.length) == t
              );
            }),
            (Gn.subtract = Nc),
            (Gn.sum = function (e) {

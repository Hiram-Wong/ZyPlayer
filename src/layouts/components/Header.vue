<template>
  <div class="titlebar" :class="systemPlatform === 'win32' ? 'windows' : 'linux'">
    <div class="drag-region" data-tauri-drag-region></div>

    <div v-if="systemPlatform !== 'darwin'" class="window-controls">
      <div class="control-minimize control-icon" @click="minimizeEvent">
      ...
      <div id="close" class="control-close control-icon" @click="closeEvent">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 11">
          <path

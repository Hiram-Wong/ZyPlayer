    ...
    >
      <div class="privacy-policy">
        ...
        <div class="main-content">
          ...
          <p>
            1.在使用ZyPlayer产品和服务前，请您务必仔细阅读和理解本政策，如您不同意本政策的任何内容，请您立即停止使用。当您开始使用我方提供的产品和服务时，即表示您已同意本政策。
          </p>
          <p>
            2.在您使用我们提供的服务时，我方平台并不会收集您的任何数据，所有数据均本地存储，在平台内所使用的所有内容均需您自行设置，与本平台无关，用户需自行对应用数据负责。
          </p>
          <p>3.我方平台不参与任何制作、上传、储存等内容, 禁止传播违法资源。该软件仅供学习参考。</p>
          <p>4.如您违反《中华人民共和国网络安全法》，有权需向您追责。</p>
        </div>
      </div>
    </t-dialog>
  </div>
